...
module.exports = function(grunt) {
  ...
  // don't compile or minify, just beautify and copy to ./test
  grunt.registerTask('test-scripts-browserify', ['concat:bootstrap','browserify:test','uglify:testBrowserify']);
  // compile and minify js, distribute to both ./test and ./dist
  grunt.registerTask('dist-scripts-browserify', ['concat:bootstrap','browserify:dist','uglify:distBrowserify']);
  // compile and minify js, distribute to both ./test and ./dist
  grunt.registerTask('gzip-scripts-browserify', ['concat:bootstrap','browserify:dist','uglify:gzipBrowserify']);
